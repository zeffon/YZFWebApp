...
class CourseOrg(models.Model):
    ...
    image = models.ImageField(max_length=200, upload_to='organization/%Y/%m', verbose_name=u'课程图片')
...
class Teacher(models.Model):
    organization = models.ForeignKey(CourseOrg, on_delete=models.CASCADE, verbose_name=u'所属机构')
